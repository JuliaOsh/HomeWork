...
namespace HomeWork
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"studentknowladges: {allKnowledges}");

            if (isBackender)
            {
                Console.WriteLine("Can be BE developer");
            }

            if (isFrontender)
            {
                Console.WriteLine("Can be FE developer");
            }

            if (isDesigner)
            {
                Console.WriteLine("Can be designer");
            }
        }
    }
}
